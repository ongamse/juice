...
import * as address from './routes/shipping/address'
import * as chatbot from './routes/communication/chatbot'
import * as metrics from './routes/admin-b2b/metrics'
import * as payment from './routes/payment-billing/payment'
import { placeOrder } from './routes/order-processing/order'
import { b2bOrder } from './routes/admin-b2b/b2bOrder'
import * as delivery from './routes/shipping/delivery'
import * as recycles from './routes/admin-b2b/recycles'
import * as twoFactorAuth from './routes/user-management/2fa'
import { applyCoupon } from './routes/shopping-cart/coupon'
import dataErasure from './routes/security-privacy/dataErasure'
import { dataExport } from './routes/security-privacy/dataExport'
import { retrieveBasket } from './routes/shopping-cart/basket'
import { searchProducts } from './routes/product-catalog/search'
import { trackOrder } from './routes/order-processing/trackOrder'
import { saveLoginIp } from './routes/security-privacy/saveLoginIp'
import { serveKeyFiles } from './routes/file-management/keyServer'
import * as basketItems from './routes/shopping-cart/basketItems'
import { performRedirect } from './routes/content-mgmt/redirect'
import { serveEasterEgg } from './routes/challenge-system/easterEgg'
import { getLanguageList } from './routes/localization/languages'
import { getUserProfile } from './routes/user-management/userProfile'
import { serveAngularClient } from './routes/content-mgmt/angular'
import { resetPassword } from './routes/user-management/resetPassword'
import { serveLogFiles } from './routes/file-management/logfileServer'
import { servePublicFiles } from './routes/file-management/fileServer'
import { addMemory, getMemories } from './routes/communication/memory'
import { changePassword } from './routes/user-management/changePassword'
...
import { captchas, verifyCaptcha } from './routes/challenge-system/captcha'
import * as restoreProgress from './routes/challenge-system/restoreProgress'
import { checkKeys, nftUnlocked } from './routes/challenge-system/checkKeys'
import { retrieveLoggedInUser } from './routes/user-management/currentUser'
import authenticatedUsers from './routes/user-management/authenticatedUsers'
import { securityQuestion } from './routes/user-management/securityQuestion'
import { servePremiumContent } from './routes/challenge-system/premiumReward'
import { contractExploitListener } from './routes/web3-nft/web3Wallet'
import { updateUserProfile } from './routes/user-management/updateUserProfile'
import { getVideo, promotionVideo } from './routes/content-mgmt/videoHandler'
import { likeProductReviews } from './routes/reviews-feedback/likeProductReviews'
import { repeatNotification } from './routes/communication/repeatNotification'
import { serveQuarantineFiles } from './routes/file-management/quarantineServer'
import { showProductReviews } from './routes/reviews-feedback/showProductReviews'
import { nftMintListener, walletNFTVerify } from './routes/web3-nft/nftMint'
import { createProductReviews } from './routes/reviews-feedback/createProductReviews'
import { getWalletBalance, addWalletBalance } from './routes/payment-billing/wallet'
import { retrieveAppConfiguration } from './routes/admin-b2b/appConfiguration'
import { updateProductReviews } from './routes/reviews-feedback/updateProductReviews'
import { servePrivacyPolicyProof } from './routes/security-privacy/privacyPolicyProof'
import { profileImageUrlUpload } from './routes/file-management/profileImageUrlUpload'
import { profileImageFileUpload } from './routes/file-management/profileImageFileUpload'
import { serveCodeFixes, checkCorrectFix } from './routes/challenge-system/vulnCodeFixes'
import { imageCaptchas, verifyImageCaptcha } from './routes/challenge-system/imageCaptcha'
import { upgradeToDeluxe, deluxeMembershipStatus } from './routes/payment-billing/deluxe'
import { serveCodeSnippet, checkVulnLines } from './routes/challenge-system/vulnCodeSnippet'
import { orderHistory, allOrders, toggleDeliveryStatus } from './routes/order-processing/orderHistory'
import { continueCode, continueCodeFindIt, continueCodeFixIt } from './routes/challenge-system/continueCode'
import { ensureFileIsPassed, handleZipFileUpload, checkUploadSize, checkFileType, handleXmlUpload, handleYamlUpload } from './routes/file-management/fileUpload'
